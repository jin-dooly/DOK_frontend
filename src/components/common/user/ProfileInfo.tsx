...
export function ProfileInfo({ _id, profileImg, nickname, time, size }: ProfileInfoProps) {
  const [userImage, setUserImage] = useState<string | undefined>(profileImg);
